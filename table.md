...
## category
```mysql
insert into category values('d00001', '계절가전', 'root');
...
insert into category values('d00002', '생활가전', 'root');
...
insert into category values('d00003', '주방가전', 'root');
...
insert into category values('d00004', '음향가전', 'root');
...
insert into category values('d00005', '영상가전', 'root');
insert into category values('d00006', 'PC주변기기', 'root');
insert into category values('d00007', '저장장치', 'root');
insert into category values('d00008', '이미용가전', 'root');
insert into category values('d00009', '게임/타이틀', 'root');
...
insert into category values('d00010', 'PC부품', 'root');
insert into category values('d00011', '네트워크장비', 'root');
insert into category values('d00012', '자동차기기', 'root');
```
